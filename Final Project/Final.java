...
class Final {
	public static void main(String[] args) {
		...
		String gregRockey = "As the light fades you find yourself in an empty computer lab. Everything is dark. But in the corner you see the shadow of a man. The shadow moves toward the light. You panick because you can sense the raw power of this being. As the shadow steps into the light your worst fear is realized. The powerful being is none other than Greg Davis. Do you choose to attack or defend?";
